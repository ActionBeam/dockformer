...
# @torch.jit.script
def _quaternion_mul(a: torch.Tensor, b: torch.Tensor) -> torch.Tensor:   # (a * b)
    """
...
def quaternion_translation_compose(qt1: QuaternionTranslation, qt2: QuaternionTranslation) -> QuaternionTranslation:  # q2进行了一个q1的旋转和平移
    qr = quaternion_mul(qt1[0], qt2[0])  # q1 * q2
